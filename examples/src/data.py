...
def load_data(config: Config):
    queries_df = pd.read_csv(config.users_path)
    console.print("Users data loaded.")
    candidates_df = pd.read_csv(config.items_path)
    ...
    return queries_df, candidates_df, interactions_df
...
def load_training_frames(
    ...
    queries_df, candidates_df, interactions_df = load_data(config)
    prepared = prepare_interactions(interactions_df, queries_df, candidates_df)
    ...
    return queries_df, candidates_df, train_df, valid_df, test_df
