...
def test_top_level_exports_are_explicit_and_import_star_safe():
    assert twotower.__all__ == [
        "TwoTower", "FitResult", "normalize_interactions", "split_interactions", "__version__",
    ]
    ...
    assert namespace["FitResult"] is twotower.FitResult
    assert namespace["normalize_interactions"] is twotower.normalize_interactions
